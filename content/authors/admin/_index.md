...
(Last updated: <script>const monthNames = ["January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December"]; document.write( monthNames[new Date().getMonth()] );</script> <script>document.write( new Date().getFullYear() );</script>)
